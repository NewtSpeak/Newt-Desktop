/* @ts-self-types="./denoise_voice_core.d.ts" */

export class VoiceClarityWasm {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        VoiceClarityWasmFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_voiceclaritywasm_free(ptr, 0);
    }
    /**
     ...
     */
    get frame_size() {
        const ret = wasm.voiceclaritywasm_frame_size(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     ...
     */
    constructor() {
        const ret = wasm.voiceclaritywasm_new();
        this.__wbg_ptr = ret;
        VoiceClarityWasmFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    process(frame) {
        var ptr0 = passArrayF32ToWasm0(frame, wasm.__wbindgen_malloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.voiceclaritywasm_process(this.__wbg_ptr, ptr0, len0, frame);
    }
    reset() {
        wasm.voiceclaritywasm_reset(this.__wbg_ptr);
    }
    /**
     * @param {number} db
     */
    set_attenuation_limit_db(db) {
        wasm.voiceclaritywasm_set_attenuation_limit_db(this.__wbg_ptr, db);
    }
    /**
     * @param {boolean} enabled
     */
    set_enabled(enabled) {
        wasm.voiceclaritywasm_set_enabled(this.__wbg_ptr, enabled);
    }
    /**
     * Adjust the presence-EQ lift at runtime (the main "clarity strength" knob).
     * @param {number} db
     */
    set_presence_gain_db(db) {
        wasm.voiceclaritywasm_set_presence_gain_db(this.__wbg_ptr, db);
    }
}
if (Symbol.dispose) VoiceClarityWasm.prototype[Symbol.dispose] = VoiceClarityWasm.prototype.free;
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./denoise_voice_core_bg.js": import0,
    };
}

const VoiceClarityWasmFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_voiceclaritywasm_free(ptr, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('denoise_voice_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
